...
namespace FB_API_Plugin.Webdriver
{
    /// <summary>
    ...
    public class Cookie
    {
        ...
        /// 
        /// 
        public Cookie(string import)
        {
            var splitimport = import.Split(';');
            //MessageBox.Show("Cookie: " + import);
            foreach (var s in splitimport)
            {
                //MessageBox.Show("S" + s);
                ...
                {
                    cookieName = s.Remove(0, 5);

                }
                else if (s.StartsWith("value="))
                {
                    cookieValue = s.Remove(0, 6);
                ...
                */
                ...
                {
                    // cookiePath = s.Remove(0, 5);
                    cookiePath = null;
                }
                else if (s.StartsWith(" domain="))
                {
                    // cookieDomain = s.Remove(0, 7);
                    cookieDomain = null;
                }
                else if (s.StartsWith(" expires="))
                {
                    // string st = s.Remove(0, 8);
                    // cookieExpiry = Convert.ToDateTime(st);
                    cookieExpiry = null;
                }
                else
                {
