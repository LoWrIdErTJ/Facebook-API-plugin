...
using System.IO;
using FB_API_Plugin.Webdriver.Internal;
using FB_API_Plugin.Webdriver.Remote.JsonConverters;
...
namespace FB_API_Plugin.Webdriver.Firefox
{
    ...
    public class FirefoxProfile
    {
        ...
        // Das hier wird umgebogen auf %appdata%. Es wird erst als File gesucht. Wenn es da nicht gefunden wird, dann als Resource.
        private static readonly string ExtensionFileName = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\WebDriver.FirefoxExt.zip";

        //private const string ExtensionResourceId = "WebDriver.FirefoxExt.zip";
        private const string ExtensionResourceId = "ExBrowser.Resources.WebDriver.FirefoxExt.zip";
        ...
        private void ReadDefaultPreferences()
        {
            ...
            using (Stream defaultPrefsStream = ResourceUtilities.GetResourceStream("webdriver.json", "ExBrowser.Resources.WebDriver.FirefoxPreferences"))
            {
