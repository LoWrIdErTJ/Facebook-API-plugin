...
namespace FB_API_Plugin.Ubot_Commands
{
    internal class SearchGroupsByParent : IUBotCommand
    {
        ...
        {
            get { return "fb api search groups by parent"; }
        }
        ...
        public void Execute(IUBotStudio ubotStudio, Dictionary<string, string> parameters)
        {
            ...
            try
            {
                ...
                var ObjectFb = facebook.GetConnections(parameters["Parent"], "groups", dict);
    ...
    internal class SearchPagesByParent : IUBotCommand
    {
        private readonly List<UBotParameterDefinition> _parameters = new List<UBotParameterDefinition>();

        public SearchPagesByParent()
        {
            _parameters.Add(new UBotParameterDefinition("Parent", UBotType.String));
            _parameters.Add(new UBotParameterDefinition("Data", UBotType.UBotTable));
        }
        ...
        public string CommandName
        {
            get { return "fb api search pages by parent"; }
        }
        ...
        public void Execute(IUBotStudio ubotStudio, Dictionary<string, string> parameters)
        {
            ...
            try
            {
                ...
                var dict = new Dictionary<string, string>();
                dict.Add("fields", "id,name");
                var ObjectFb = facebook.GetConnections(parameters["Parent"], "likes", dict);
                //_returnValue = facebook.JsonText;
                var Jpath = JsonPathParser(facebook.JsonText, "$..next");
