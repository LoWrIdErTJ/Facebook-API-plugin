...
{
    internal class Search_objects : IUBotFunction
    {
        ...
        public void Execute(IUBotStudio ubotStudio, Dictionary<string, string> parameters)
        {
            ...
            try
            {
                ...
                dict.Add("type", parameters["Search Type"]);
                dict.Add("limit", "100");
    ...
    internal class getparentposts : IUBotFunction
    {
        private object _lockit = new object();
        // List to hold the parameters we define for our command.
        private readonly List<UBotParameterDefinition> _parameters = new List<UBotParameterDefinition>();
        ...
        public string FunctionName
        {
            // The name of our node in UBot Studio.
            // You need to use a $ sign in front of function names.
            get { return "$fb api search parent posts Ids"; }
        }
        ...
        public void Execute(IUBotStudio ubotStudio, Dictionary<string, string> parameters)
        {
            ...
            try
            {
                ...
                var ScrapedData = new List<string>();
                var dict = new Dictionary<string, string>();
                dict.Add("fields", "id,name");
                var ObjectFb = facebook.GetConnections(parameters["parent"], "posts", dict);
    ...
    internal class getparentevents : IUBotFunction
    {
        private object _lockit = new object();
        // List to hold the parameters we define for our command.
        private readonly List<UBotParameterDefinition> _parameters = new List<UBotParameterDefinition>();
        ...
        public string FunctionName
        {
            // The name of our node in UBot Studio.
            // You need to use a $ sign in front of function names.
            get { return "$fb api search parent events Ids"; }
        }
        ...
        public void Execute(IUBotStudio ubotStudio, Dictionary<string, string> parameters)
        {
            ...
            try
            {
                ...
                var dict = new Dictionary<string, string>();
                dict.Add("fields", "id,name");
                var ObjectFb = facebook.GetConnections(parameters["parent"], "events", dict);
