...
{
    internal class GetFQLdata : IUBotFunction
    {
        ...
        public GetFQLdata()
        {
            _parameters.Add(new UBotParameterDefinition("FQL Query", UBotType.String));
        ...
        public void Execute(IUBotStudio ubotStudio, Dictionary<string, string> parameters)
        {
            ...
            try
            {
                ...
                dict.Add("q", parameters["FQL Query"]);
                dict.Add("limit", "5000");
                dict.Add("format", "json");
                dict.Add("suppress_http_code", "1");
                var ObjectFb = facebook.GetConnections("", "fql", dict);
