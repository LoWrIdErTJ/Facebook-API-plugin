...
{
    internal class GetGroupsDetails : IUBotFunction
    {
        ...
        public string FunctionName
        {
            ...
            get { return "$fb api group details search"; }
        }
        ...
        public void Execute(IUBotStudio ubotStudio, Dictionary<string, string> parameters)
        {
            ...
            try
            {
                ...
                dict.Add("fields", "id");
                dict.Add("limit", "100");
                var ObjectFb = facebook.GetConnections(parameters["group id"], parameters["List"], dict);
